...
class Bank(models.Model):
    ...
    start = fields.Integer('Inicio', default=1)
    end = fields.Integer('Fin', default=9999)
    padding = fields.Integer('Dígitos', default=7, help="Cantidad de dígitos en el talonario de la chequera")
    state_id = fields.Many2one("res.country.state", string='Provincia')
    code = fields.Char('Código', size=2, help='Campo qué sirve para generación de archivo SAT.')
